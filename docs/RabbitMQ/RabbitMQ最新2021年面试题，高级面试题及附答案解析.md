...
### [8、交换器4种类型？](https://github.com/souyunku/DevBooks/blob/master/docs/RabbitMQ/RabbitMQ最新2021年面试题，高级面试题及附答案解析.md#8交换器4种类型)  
...
### [9、交换器无法根据自身类型和路由键找到符合条件队列时，有哪些处理？](https://github.com/souyunku/DevBooks/blob/master/docs/RabbitMQ/RabbitMQ最新2021年面试题，高级面试题及附答案解析.md#9交换器无法根据自身类型和路由键找到符合条件队列时有哪些处理)  
...
### [10、RabbitMQ队列结构？](https://github.com/souyunku/DevBooks/blob/master/docs/RabbitMQ/RabbitMQ最新2021年面试题，高级面试题及附答案解析.md#10rabbitmq队列结构)  
