...
### [8、介绍一下你对浏览器内核的理解？](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端面试题大汇总，2021年附答案解析.md#8介绍一下你对浏览器内核的理解)  
...
### [9、为什么在 JS 中比较两个相似的对象时返回 false？](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端面试题大汇总，2021年附答案解析.md#9为什么在-js-中比较两个相似的对象时返回-false)  
...
### [10、li与li之间有看不见的空白间隔是什么原因引起的？有什么解决办法？](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端面试题大汇总，2021年附答案解析.md#10li与li之间有看不见的空白间隔是什么原因引起的有什么解决办法)  
