...
### [8、DOCTYPE有什么作用？标准模式与混杂模式如何区分？它们有何意义?](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端最新面试题，常见面试题及答案汇总.md#8doctype有什么作用标准模式与混杂模式如何区分它们有何意义)  
...
### [9、`display: none;`与`visibility: hidden;`的区别](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端最新面试题，常见面试题及答案汇总.md#9display:-none;与visibility:-hidden;的区别)  
...
### [10、css3有哪些新特性](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端最新面试题，常见面试题及答案汇总.md#10css3有哪些新特性)  
