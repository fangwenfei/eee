...
### [8、空元素定义](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端最新2021年面试题，高级面试题及附答案解析.md#8空元素定义)  
...
### [9、什么是作用域和作用域链？](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端最新2021年面试题，高级面试题及附答案解析.md#9什么是作用域和作用域链)  
...
### [10、title与h1的区别、b与strong的区别、i与em的区别](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端最新2021年面试题，高级面试题及附答案解析.md#10title与h1的区别b与strong的区别i与em的区别)  
