...
### [8、微信小程序，如何封装数据请求](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端最新面试题2021年，常见面试题及答案汇总.md#8微信小程序如何封装数据请求)  
...
### [9、javascript创建对象的几种方式？](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端最新面试题2021年，常见面试题及答案汇总.md#9javascript创建对象的几种方式)  
...
### [10、async 和 defer 的作用是什么？有什么区别？（浏览器解析过程）](https://github.com/souyunku/DevBooks/blob/master/docs/前端/前端最新面试题2021年，常见面试题及答案汇总.md#10async-和-defer-的作用是什么有什么区别浏览器解析过程)  
