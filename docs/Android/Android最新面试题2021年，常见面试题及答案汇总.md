...
### 4、在 service 的生命周期方法 onstartConmand()可不可以执行网络操作？如何在 service 中执行网络操作？
...
### 11、Android本身的api并未声明会抛出异常，则其在运行时有无可能抛出runtime异常，你遇到过吗？诺有的话会导致什么问题？如何解决？
### 12、java中如何引用本地语言
### 13、ListView 如何提高其效率？
### 14、android的数据存储
### 15、请解释下在单线程模型中Message、Handler、Message Queue、Looper之间的关系。
### 16、谈谈对Android NDK的理解
### 17、Adapter是什么？你所接触过的adapter有那些？
### 18、请介绍下 ContentProvider 是如何实现数据共享的
### 19、广播接受者的生命周期？
### 20、什么是IntentService？有何优点？
### 21、ListView 如何定位到指定位置
### 22、请描述下Activity的生命周期。
### 23、描述下Handler 机制
### 24、消息推送的方式
### 25、sim卡的EF 文件有何作用
