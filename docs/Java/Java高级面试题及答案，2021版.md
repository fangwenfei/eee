...
### [8、同步方法和同步块，哪个是更好的选择？](https://github.com/souyunku/DevBooks/blob/master/docs/Java/Java高级面试题及答案，2021版.md#8同步方法和同步块哪个是更好的选择)  
...
### [9、运行时常量池的作用是什么?](https://github.com/souyunku/DevBooks/blob/master/docs/Java/Java高级面试题及答案，2021版.md#9运行时常量池的作用是什么)  
...
### [10、如果你提交任务时，线程池队列已满，这时会发生什么](https://github.com/souyunku/DevBooks/blob/master/docs/Java/Java高级面试题及答案，2021版.md#10如果你提交任务时线程池队列已满这时会发生什么)  
