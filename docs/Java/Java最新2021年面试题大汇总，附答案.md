...
### [8、Hibernate中Session的load和get方法的区别是什么？](https://github.com/souyunku/DevBooks/blob/master/docs/Java/Java最新2021年面试题大汇总，附答案.md#8hibernate中session的load和get方法的区别是什么)  
...
### [9、说一下堆内存中对象的分配的基本策略](https://github.com/souyunku/DevBooks/blob/master/docs/Java/Java最新2021年面试题大汇总，附答案.md#9说一下堆内存中对象的分配的基本策略)  
...
### [10、Java 中如何将字符串转换为整数？](https://github.com/souyunku/DevBooks/blob/master/docs/Java/Java最新2021年面试题大汇总，附答案.md#10java-中如何将字符串转换为整数)  
