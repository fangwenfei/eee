...
### [8、接口和抽象类有什么区别？](https://github.com/souyunku/DevBooks/blob/master/docs/Java/Java面试题大汇总，2021面试题及答案汇总.md#8接口和抽象类有什么区别)  
...
### [9、原型模式的应用场景](https://github.com/souyunku/DevBooks/blob/master/docs/Java/Java面试题大汇总，2021面试题及答案汇总.md#9原型模式的应用场景)  
...
### [10、ConcurrentHashMap 和 Hashtable 的区别？](https://github.com/souyunku/DevBooks/blob/master/docs/Java/Java面试题大汇总，2021面试题及答案汇总.md#10concurrenthashmap-和-hashtable-的区别)  
