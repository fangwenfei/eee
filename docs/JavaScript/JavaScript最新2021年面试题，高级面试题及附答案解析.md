...
### [8、$$('div+.ab')和$$('.ab+div') 哪个效率高？](https://github.com/souyunku/DevBooks/blob/master/docs/JavaScript/JavaScript最新2021年面试题，高级面试题及附答案解析.md#8$$'div+ab'和$$'ab+div'-哪个效率高)  


$('div+.ab')效率高


### [9、什么是类？](https://github.com/souyunku/DevBooks/blob/master/docs/JavaScript/JavaScript最新2021年面试题，高级面试题及附答案解析.md#9什么是类)  
...
### [10、如何判断值是否为数组？](https://github.com/souyunku/DevBooks/blob/master/docs/JavaScript/JavaScript最新2021年面试题，高级面试题及附答案解析.md#10如何判断值是否为数组)  
